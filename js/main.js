/* =====================================================
   ...
   Loads the stable interaction layer and ordered refinement
   layers used by the refinement branch.
===================================================== */
...
const runAccessibilityQa = () => {
  ...
  style.textContent = `
    ...
    .testimonial-carousel-refined { outline: none; }
    ...
    .testimonial-dot:disabled { cursor: default; }
